...
export class AuthService {
  ...
  blogRequest(formData): Observable<any> {
    return this.http
      .post(this.urlEndpoint + 'api/common/blogs', formData)
      .pipe(catchError((errorRes) => throwError(this.getErrorMessage(errorRes))));
  }

  deleteBlog(id: string) {
    return this.http
      .delete(this.urlEndpoint + 'api/common/blogs/' + id)
      .pipe(catchError((errorRes) => throwError(this.getErrorMessage(errorRes))));
  }

  addFaq(data: { title: string; body: { tag: string; element: string; }[]; }) {
    return this.http
      .post(this.urlEndpoint + 'api/common/faqs', data)
      .pipe(catchError((errorRes) => throwError(this.getErrorMessage(errorRes))));
  }

  deleteFaq(id: string) {
    return this.http
      .delete(this.urlEndpoint + 'api/common/faqs/' + id)
      .pipe(catchError((errorRes) => throwError(this.getErrorMessage(errorRes))));
  }
